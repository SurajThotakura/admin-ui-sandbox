...
import { OrganizationDetailsFactory, OrganizationDetailsMappers } from '@auth0/universal-components-core';
...
const organizationDetailsQueryKeys = {
  ...
  details: () => [...organizationDetailsQueryKeys.all, 'details'],
};
...
export function useOrganizationDetailsEdit(
  ...
  const updateOrgDetails = useCallback(async data => {
