...
function ImagePreviewField({
  ...
  const [imageUrl, setImageUrl] = React.useState(value?.toString() || '');
    ...
    <div className="space-y-2">
      <div
        ...
        {showPreview ? (
          ...
          <div
            className="text-muted-foreground flex h-full w-full flex-col items-center justify-center gap-2 text-sm">
            {previewIcon}
