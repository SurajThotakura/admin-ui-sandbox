 ...
 * @internal
 */
export function resolveCacheConfig(userConfig) {
  const merged = {
 ...
 */
function isGateKeeperError(query) {
 ...
 * @internal
 */
function createQueryClient(cacheConfig, setGateKeeperState) {
...
export function QueryProvider(
  ...
  const [gateKeeperState, setGateKeeperState] = useState(null);
